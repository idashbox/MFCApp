...
// MFCApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCAppApp, CWinAppEx)
...
// Единственный объект CMFCAppApp

CMFCAppApp theApp;


// Инициализация CMFCAppApp
...
// Обработчики сообщений CMFCAppApp
...
// Методы загрузки или сохранения настроек CMFCAppApp

void CMFCAppApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMFCAppApp::LoadCustomState()
{
}

void CMFCAppApp::SaveCustomState()
{
}
